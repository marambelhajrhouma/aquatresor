...
import { FormBuilder, FormGroup, Validators } from '@angular/forms'; // Importez ReactiveFormsModule
...
export class SendInstallerInvitationComponent implements OnInit {
  ...
  constructor(
    private fb: FormBuilder, // FormBuilder est fourni par ReactiveFormsModule
